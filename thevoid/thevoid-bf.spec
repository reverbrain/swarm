...
Source:		https://github.com/reverbrain/swarm/archive/thevoid-%{version}.tar.gz
...
BuildRequires: boost%{boost_ver}-program-options-devel
BuildRequires: boost%{boost_ver}-regex-devel
BuildRequires: libblackhole-devel
BuildRequires: libswarm3-devel
BuildRequires: cmake
